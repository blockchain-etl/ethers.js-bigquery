...
var interface_instance = new ethers.utils.Interface([
    {
        "anonymous": false,
        "inputs": [
            {
...
for (var event in interface_instance.events) {
    if (interface_instance.events.hasOwnProperty(event)) {
        console.log(event + ': ' + interface_instance.events[event].topic)
    }
}
